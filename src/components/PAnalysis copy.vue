...
export default {
      ...
      pitchersData: [
        {
          ...
          url: '<iframe width="600" height="373.5" src="https://app.powerbi.com/view?r=eyJrIjoiMzA3NjBiN2MtNzkwNS00OTQ2LThlNjUtOGE1YTJmYTA2NjIwIiwidCI6Ijc5NWU0N2Q5LTVlODctNDAyOS04MzU1LTU3NTM3Yzc0M2UwOSJ9&pageName=ReportSection" frameborder="0" allowFullScreen="true"></iframe>'
        },
        {
          year: 2019,
          league: 'NL',
          team: 'CHC',
          name: 'Darvish Yu',
          url: '<iframe width="600" height="373.5" src="https://app.powerbi.com/view?r=eyJrIjoiZjIxN2IxZjQtNmIyNS00ZTFlLWE1MmYtN2VlMmQ5OWM5ZGE2IiwidCI6Ijc5NWU0N2Q5LTVlODctNDAyOS04MzU1LTU3NTM3Yzc0M2UwOSJ9&pageName=ReportSectiona161acc2bcb326b022ce" frameborder="0" allowFullScreen="true"></iframe>'
        },
        {
          year: 2019,
          league: 'NL',
          team: 'LAD',
          name: 'Kenta Maeda',
          url: '<iframe width="600" height="373.5" src="https://app.powerbi.com/view?r=eyJrIjoiZjkxOTRkNGEtNDhkYi00OWQ1LThmNzQtZWU5NTkyY2M4ZjIxIiwidCI6Ijc5NWU0N2Q5LTVlODctNDAyOS04MzU1LTU3NTM3Yzc0M2UwOSJ9" frameborder="0" allowFullScreen="true"></iframe>'
        },
        {
          year: 2019,
          league: 'AL',
          team: 'NYY',
          name: 'Gerrit Cole',
          url: '<iframe width="600" height="373.5" src="https://app.powerbi.com/view?r=eyJrIjoiYzQ1YTVmM2QtZjAzOC00ZDcwLTgzNGQtNTMzZWMwYzYyMGEwIiwidCI6Ijc5NWU0N2Q5LTVlODctNDAyOS04MzU1LTU3NTM3Yzc0M2UwOSJ9&pageName=ReportSection" frameborder="0" allowFullScreen="true"></iframe>'
        }
      ]
    }
  },
  ...
  methods: {
    ...
    // 未使用
    createProvidedTeams (items, targetYear, targetLeague) {
      const teams = items
        .map((item) => {
          if (item.year === targetYear && item.league === targetLeague) {
            return item.team
          }
        }) // 1. 各要素オブジェクトから、"year"に合致するチームのみを返す
        .filter(Boolean)
    ...
    createSelectData (items) {
      ...
      const years = items
        ...
        .filter(Boolean)
        .reduce(this.findoutUnique, []) // 3. uniqueな値のみを抽出
      years.sort(numDescendingOrder) // 2. "year"の値が格納された配列をソート
      ...
      years.forEach((targetYear) => {
        ...
        leagues.forEach((targetLeague) => {
          ...
          teams.forEach((targetTeam) => {
            ...
            returnObjects.push(insertObject)
          })
        })
      })
